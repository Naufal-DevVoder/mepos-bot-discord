...
let questions = [
  ...
  {
    title: "Who is the server owner of animekuy",
    options: ["ShotaxBabyra", "TD", "Shiro", "Memed"],
    correct: 1
  },
  {
    title: "Who is official server bot",
    options: ["Alita", "Anigame", "Tsubaki", "Shoob"],
    correct: 3
  },
  {
  ...
  {
    title:
      "Sasageyo sasageyo shinzou wo sasageyo,merupakan opening shingeki no kyojin season",
    options: ["1", "2", "3", "4"],
    correct: 2
  },
  {
  ...
  {
    title: "Botak Pengendali 4 elemen",
    options: ["Upin", "Ipin", "Saitama", "Aang"],
    correct: 4
  },
  {
    title: "Di stasiun TV Indonesia manakah,Anime Aikatsu pernah Ditanyangkan",
    options: ["Indosiar", "RTV", "RCTI", "TV one"],
    correct: 3
  },
  {
  ...
  {
    title: "Negara manakah yang menjadi sekutu Nazi",
    options: ["Korea", "USSR", "Amerika", "Italia"],
    correct: 4
  },
  {
...
module.exports = {
  ...
  run: async (bot, message, args) => {
    ...
    const user =
      ...
      message.author;
    let corrects = db.get(`corrects_${message.guild.id}_${message.author.id}`);
    //batas
    ...
    try {
      ...
      if (parseInt(msgs.first().content) == q.correct) {
        db.add(`corrects_${message.guild.id}_${user.id}`, 500);
        await message.reply(`You got it correct!`);
